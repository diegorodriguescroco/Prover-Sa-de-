...
export default function Admin() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-[#F4F7FC]">
      {/* Topbar */}
      <header className="bg-white border-b border-slate-200 px-5 h-14 flex items-center justify-between gap-4 sticky top-0 z-40 shadow-sm">
        <div className="flex items-center gap-3">
          <Logo size={36} />
          <span className="bg-navy text-white text-[10px] font-bold tracking-widest uppercase px-2.5 py-1 rounded-full">
            Admin
          </span>
        </div>
        <button
